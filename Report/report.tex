...
The incident---also known as Trisis [citation] and Hatman [citation]---is chosen as an example for several reasons.
First and foremost it was the first attack targetting SIS and therefore potentially threatening human lives.
Additionally, the attack was highly sophisticated and even if it was eventually detected by the plant operators, they were not able to stop it immediately.
% Outline?
