...
In total, a minimum of 67\% of the attacks are known to be at least partly successful.
...
The incidents which are considered to be unsuccessful include two well-known attacks.
First, there is Triton which failed for reasons not fully understood up until today.
Section 4 will provide a detailed analysis of the incident and its impacts.
Second, LockerGoga is a ransomware targeting also ICS environments.
In 2019, the production line of a Norwegian aluminium producer was hit by the attackers, the majority of hard drives were encrypted and a ransom payment was demanded.
Due to existing backups that could be used to restore normal operations, a ransom payment could be avoided, however.
