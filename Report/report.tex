...
Those form the basis of the following analysis and can be found in \autoref{tab:incidents}.
...
\autoref{section:triton} will provide a detailed analysis of the incident and its impacts.
